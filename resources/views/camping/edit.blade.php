                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control border border-dark-subtle"
                                            id="persona_contacto" placeholder="Ex: David Serrano Mellinas"
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="telefono_contacto" class="form-label fw-bold">Teléfono de
                                            contacto</label>
                                        <input type="text" class="form-control border border-dark-subtle"
                                            id="telefono_contacto" placeholder="Ex: 656 56 56 56"
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control border border-dark-subtle"
                                            id="correo_contacto" placeholder="Ex: example@gmail.com"
